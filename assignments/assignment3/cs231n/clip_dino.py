...
class DavisDataset:
    def __init__(self, data_dir=None):
        try:
            ...
            raise ImportError(
                "DAVIS requires optional data dependencies. From assignments run: "
                "uv sync --extra assignment3 --extra davis"
            ) from exc
        self.tfds = tfds
        self.davis = tfds.load('davis/480p', split='validation', as_supervised=False, data_dir=data_dir)
